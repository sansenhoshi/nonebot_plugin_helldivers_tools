...
## ~~战备数据已更新至2026年2月27日~~
## 战备数据已更新至2026年4月28日
- 现已增加战备的别名，由于图片篇幅有限，将会在多个别名中随机选择一个，如果有更好的答案可以提到issue

## 功能

- ~~简报，从 https://hd2galaxy.com 获取最新得星系战争情报（仅对该网站进行截图操作，本人对星球名字做了文本对照，使其与游戏内对应）~~ 简报功能暂时无法使用
